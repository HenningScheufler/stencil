...
void Foam::CPCCellToCellStencilCellBased::calcPointBoundaryData
(
...
{
    addProfiling(stencil, "CPCCellToCellStencilCellBased::calcPointBoundaryData");
...
void Foam::CPCCellToCellStencilCellBased::calcCellStencil
(
    labelListList& globalCellCells
) const
{
    addProfiling(stencil, "CPCCellToCellStencilCellBased::calcCellStencil");
...
Foam::CPCCellToCellStencilCellBased::CPCCellToCellStencilCellBased(const polyMesh& mesh)
:
