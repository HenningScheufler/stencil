...
template<class Type>
Foam::extendedCelltoCellStencilLooper<Type>::extendedCelltoCellStencilLooper
(
...
// template<class Type>
// void Foam::extendedCelltoCellStencilLooper<Type>::compact()
// {
...
template<class Type>
const Foam::stencilLoop<Type> Foam::extendedCelltoCellStencilLooper<Type>::operator[](const label i) const
{
...
template class Foam::extendedCelltoCellStencilLooper<Foam::scalar>;
